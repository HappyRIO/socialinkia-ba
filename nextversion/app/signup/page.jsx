...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate.push("/signup/details"); // Use navigate for internal routing
      } else {
  ...
  const googlesignup = () => {
    const backendUrl = `${process.env.NEXT_PUBLIC_SERVER_BASE_URL}/api/google/auth/google?redirectToDashboard=true`;
